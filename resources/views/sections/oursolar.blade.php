<section id="everything-you-need-to-know" class="py-5 px-3">
  <div class="container">
    <h2 class="fw-bold text-center mb-5 fs-2">What our solar calculator will tell you</h2>

    <div class="row g-5">
      <div class="col-lg-4 col-md-6 text-center">
        <img src="https://www.mysolar.com/assets/images/solar-panels.png" alt="solar panels" class="img-fluid mb-3">
        <h4 class="fw-semibold fs-5 mb-3">How many solar panels you need</h4>
      ...
      <div class="col-lg-4 col-md-6 text-center">
        <img src="https://www.mysolar.com/assets/images/tax-credits.png" alt="tax credits" class="img-fluid mb-3">
        <h4 class="fw-semibold fs-5 mb-3">Solar tax credits &amp; rebates available to you</h4>
        <p class="text-secondary">
      ...
      <div class="col-lg-4 col-md-6 text-center">
        <img src="https://www.mysolar.com/assets/images/money-save.png" alt="saving money" class="img-fluid mb-3">
        <h4 class="fw-semibold fs-5 mb-3">Solar panel costs in 2024</h4>
        <p class="text-secondary">
      ...
      <div class="col-lg-4 col-md-6 text-center">
        <img src="https://www.mysolar.com/assets/images/save-money-piggy.png" alt="piggy bank" class="img-fluid mb-3">
        <h4 class="fw-semibold fs-5 mb-3">Your savings from solar</h4>
        <p class="text-secondary">
      ...
      <div class="col-lg-4 col-md-6 text-center">
        <img src="https://www.mysolar.com/assets/images/installer.png" alt="installer" class="img-fluid mb-3">
        <h4 class="fw-semibold fs-5 mb-3">The best installation companies where you live</h4>
        <p class="text-secondary">
      ...
      <div class="col-lg-4 col-md-6 text-center">
        <img src="https://www.mysolar.com/assets/images/solar-house.png" alt="solar house" class="img-fluid mb-3">
        <h4 class="fw-semibold fs-5 mb-3">The solar system size that’s right for your home</h4>
        <p class="text-secondary">
